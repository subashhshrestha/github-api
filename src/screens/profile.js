...
export default class Profile extends Component {
  ...
  componentDidMount() {
    ...
    fetch(
      `https://api.github.com/users/${this.props.location.state.username}/repos`
    )
      .then(res => res.json())
      .then(datas => {
    ...
    return (
      <div className="profile">
        ...
        <div className="leftSide">
          <img
            style={{ width: "95%", borderRadius: "3px", marginTop: "30px" }}
          ...
          <span style={{ fontStyle: "Segoe UI Light", fontSize: "12px" }}>
            <span
              style={{
                color: "#969696",
                marginRight: "10px",
        ...
        <div className="rightSide">
          <div className="profileReposList">
            <div style={{ height: "8%" }} />
            <div className="profileNav">
              ...
              <span style={{ fontFamily: "Segoe UI Light", fontSize: "12px",display:"flex",
                  justifyContent:"center",
                  alignItems:"center"}}>
                Repositories <span style={{height:'15px',width:'14px',borderRadius:'50%',backgroundColor:'gray',alignSelf:"center",marginLeft:"5px",color:"white",display:"flex",justifyContent:"center"}}>{this.state.user.public_repos}</span>
              </span>
              <span style={{ fontFamily: "Segoe UI Light", fontSize: "12px",display:"flex",
                  justifyContent:"center",
                  alignItems:"center"}}>
                Followers <span style={{height:'15px',width:'14px',borderRadius:'50%',backgroundColor:'gray',alignSelf:"center",marginLeft:"5px",color:"white",display:"flex",justifyContent:"center"}}>{this.state.user.followers}</span>
              </span>
              <span style={{ fontFamily: "Segoe UI Light", fontSize: "12px",display:"flex",
                  justifyContent:"center",
                  alignItems:"center"}}>
                Following <span style={{height:'15px',width:'14px',borderRadius:'50%',backgroundColor:'gray',alignSelf:"center",marginLeft:"5px",color:"white",display:"flex",justifyContent:"center"}}>{this.state.user.following}</span>
              </span>
              
            </div>
            <hr />

            <div className="profile_user_repos">
              <span
                style={{ marginTop: "15px", color: "gray", fontSize: "14px" }}
              >
                Repositories
              </span>
              <div className="repos">
                {this.state.repo.map(repo => (
                  <Repo repo={repo} color={this.state.color} />
                ))}
              </div>
            </div>
          </div>
        ...
        >
          <div
            style={{
              borderRadius: "50%",
              backgroundColor: `${
                props["color"][`${props.repo.language}`]["color"]
              }`,
              width: "15px",
              height: "15px",
              marginRight: "5px"
